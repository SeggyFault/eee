<?php
/**
 * Contains Somoscuatro\Starter_Theme\BLocks\Description\Description Class.
 *
...
namespace Somoscuatro\Starter_Theme\Blocks\Description;
...
class Description extends Block {
	...
	public function get_acf_fields(): array {
		return array(
			...
			'title'    => __( 'Block: Description', 'sc-starter-theme' ),
			'fields'   => array(
        array(
