<?php
/**
 * Contains EEE\Theme\Theme Class.
 *
 * @package eee-theme
 */
...
use EEE\Theme\Blocks\Loader as BlocksLoader;
use EEE\Theme\Custom_Post_Types\Loader as CustomPostTypesLoader;
use EEE\Theme\Custom_Taxonomies\Loader as CustomTaxonomiesLoader;
				...
				<?php
					echo wp_kses_post(
						sprintf(
							...
							__( '%s plugin is not installed. Please install the plugin to use the Ertle Custom Theme.', 'eee-theme' ),
