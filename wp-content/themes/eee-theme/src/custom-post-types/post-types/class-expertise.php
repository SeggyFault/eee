<?php
/**
 * Contains EEE\Theme\Custom_Post_Types\Post_Types\Expertise Class.
 *
 * @package eee-theme
 */
...
namespace EEE\Theme\Custom_Post_Types\Post_Types;

use EEE\Theme\Custom_Post_Types\Custom_Post_Type;

/**
 * Project Custom Post Type Functionality.
 */
class Expertise extends Custom_Post_Type {
	 ...
	 * @var string
	 */
	protected string $singular_name = 'Expertise';
	 ...
	 * @var string
	 */
	protected string $plural_name = 'Expertises';
