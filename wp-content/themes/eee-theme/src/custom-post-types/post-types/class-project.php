<?php
/**
 * Contains EEE\Theme\Custom_Post_Types\Post_Types\Project Class.
 *
 * @package eee-theme
 */
 ...
 */
class Project extends Custom_Post_Type {
	 ...
	 * @var string
	 */
	protected string $singular_name = 'Project';
	 ...
	 * @var string
	 */
	protected string $plural_name = 'Projects';
