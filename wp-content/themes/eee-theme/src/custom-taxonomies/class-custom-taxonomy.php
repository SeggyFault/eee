<?php
/**
 * Contains EEE\Theme\Custom_Taxonomies\Custom_Taxonomy Class.
 *
 * @package eee-theme
 */
...
namespace EEE\Theme\Custom_Taxonomies;
...
class Custom_Taxonomy {
	...
	public function init(): void {
		...
		$labels = array(
			...
			'all_items'         => sprintf( __( 'All %s', 'eee-theme' ), $this->plural_name ),
			'parent_item'       => sprintf( __( 'Parent %s', 'eee-theme' ), $this->singular_name ),
			'parent_item_colon' => sprintf( __( 'Parent %s', 'eee-theme' ), $this->singular_name ),
			'edit_item'         => sprintf( __( 'Edit %s', 'eee-theme' ), $this->singular_name ),
			'update_item'       => sprintf( __( 'Update %s', 'eee-theme' ), $this->singular_name ),
			'add_new_item'      => sprintf( __( 'Add New %s', 'eee-theme' ), $this->singular_name ),
			'new_item_name'     => sprintf( __( 'New %s', 'eee-theme' ), $this->singular_name ),
